...
const FAQSection = () => {
  return (
    <div className=" w-9/12 mx-auto my-32 grid md:grid-cols-2 gap-10 items-center">
      <div
        data-aos="fade-right"
        data-aos-delay="50"
      ...
      >
        <div
          style={{
            backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHIqD2vo9pb8R_HibB_nVh3MxvnYUKijQ4zQ&usqp=CAU')`,
          }}
